...
const Non_Move_Object& Map_Village::Get_NM_Object(const int& index) const {
...
void Map_Village::Set_NM_Object() {
	...
	Reset_Non_Move_Object(*nm_object[VNM_OB::House1], 560, 0, (HBITMAP)LoadImage(NULL, _T(".\\BitMap\\Map\\Village\\House1.bmp"), IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE));
	nm_object[VNM_OB::House1]->Set_Crash_Height(nm_object[VNM_OB::House1]->Get_Object_Image_Size().bmHeight);
	Reset_Non_Move_Object(*nm_object[VNM_OB::House2], Get_Map_Rect().right - 320, 720, (HBITMAP)LoadImage(NULL, _T(".\\BitMap\\Map\\Village\\House2.bmp"), IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE));
	nm_object[VNM_OB::House2]->Set_Crash_Height(nm_object[VNM_OB::House2]->Get_Object_Image_Size().bmHeight - 160);
	Reset_Non_Move_Object(*nm_object[VNM_OB::House3], 0, 720, (HBITMAP)LoadImage(NULL, _T(".\\BitMap\\Map\\Village\\House3.bmp"), IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE));
	nm_object[VNM_OB::House3]->Set_Crash_Height(nm_object[VNM_OB::House3]->Get_Object_Image_Size().bmHeight - 160);
	Reset_Non_Move_Object(*nm_object[VNM_OB::House4], 0, 0, (HBITMAP)LoadImage(NULL, _T(".\\BitMap\\Map\\Village\\House4.bmp"), IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE));
	nm_object[VNM_OB::House4]->Set_Crash_Height(nm_object[VNM_OB::House4]->Get_Object_Image_Size().bmHeight - 160);

	nm_object[VNM_OB::Lake] = Create_Class<Non_Move_Object>();
	Reset_Non_Move_Object(*nm_object[VNM_OB::Lake], 720, 800, (HBITMAP)LoadImage(NULL, _T(".\\BitMap\\Map\\Village\\Lake.bmp"), IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE));
	nm_object[VNM_OB::Lake]->Set_Crash_Height(nm_object[VNM_OB::Lake]->Get_Object_Image_Size().bmHeight);

	nm_object[VNM_OB::Wall1] = Create_Class<Non_Move_Object>();
	Reset_Non_Move_Object(*nm_object[VNM_OB::Wall1], 0, Get_Map_Rect().bottom - 160, (HBITMAP)LoadImage(NULL, _T(".\\BitMap\\Map\\Village\\Ground_Wall.bmp"), IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE));
	nm_object[VNM_OB::Wall1]->Set_Crash_Height(nm_object[VNM_OB::Wall1]->Get_Object_Image_Size().bmHeight);
}
