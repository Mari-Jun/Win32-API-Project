...
public:
	...
	void Set_Hit_Range_Polygon(const int& index, const int& owner, const bool& move, const int& direcction, const bool& guide, const POINT& speed, const int& type, const int& attack_type, const POINT pos[4], const int& delay, const double& attack_multiple);
